...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public boolean patch(ProductModel productModel) {
        Product product = getProduct(productModel.getId());
        Product mappedProduct = ProductMapper.INSTANCE.modelToEntity(productModel);
        PartialMapperUtil.getINSTANCE().mapVolData(mappedProduct, product);
        List<Category> categories = getCategories(productModel);
